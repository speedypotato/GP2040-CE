...
#define BOARD_CONFIG_LABEL "PicoV4"

// Main pin mapping Configuration
//                                                  // GP2040 | Xinput | Switch  | PS3/4/5  | Dinput | Arcade |
// #define GPIO_PIN_ GpioAction::BUTTON_PRESS_UP     // UP     | UP     | UP      | UP       | UP     | UP     |
// #define GPIO_PIN_ GpioAction::BUTTON_PRESS_DOWN   // DOWN   | DOWN   | DOWN    | DOWN     | DOWN   | DOWN   |
// #define GPIO_PIN_ GpioAction::BUTTON_PRESS_RIGHT  // RIGHT  | RIGHT  | RIGHT   | RIGHT    | RIGHT  | RIGHT  |
// #define GPIO_PIN_ GpioAction::BUTTON_PRESS_LEFT   // LEFT   | LEFT   | LEFT    | LEFT     | LEFT   | LEFT   |
...
// #define GPIO_PIN GpioAction::BUTTON_PRESS_R2     // R2     | RT     | ZR      | R2       | 8      | K3     |
// #define GPIO_PIN_ GpioAction::BUTTON_PRESS_L2     // L2     | LT     | ZL      | L2       | 7      | K4     |
...
// #define GPIO_PIN_ GpioAction::BUTTON_PRESS_L3     // L3     | LS     | LS      | L3       | 11     | LS     |
// #define GPIO_PIN_ GpioAction::BUTTON_PRESS_R3     // R3     | RS     | RS      | R3       | 12     | RS     |
// #define GPIO_PIN_ GpioAction::BUTTON_PRESS_A1     // A1     | Guide  | Home    | PS       | 13     | ~      |
// #define GPIO_PIN_ GpioAction::BUTTON_PRESS_A2     // A2     | ~      | Capture | ~        | 14     | ~      |
...
#define DEFAULT_INPUT_MODE_B1 INPUT_MODE_KEYBOARD
...
#define ENCODER_ONE_PIN_B 0
#define ENCODER_ONE_MODE ENCODER_MODE_LEFT_ANALOG_X
#define ENCODER_ONE_WRAP 1
#define ENCODER_ONE_MULTIPLIER 1.5

#define ENCODER_TWO_ENABLED 1
#define ENCODER_TWO_PPR 24
#define ENCODER_TWO_PIN_A 3
#define ENCODER_TWO_PIN_B 2
#define ENCODER_TWO_MODE ENCODER_MODE_LEFT_ANALOG_Y
#define ENCODER_TWO_WRAP 1
#define ENCODER_TWO_MULTIPLIER 1.5

...
#define BOARD_CONFIG_LABEL "PicoV5"
...
#define PIN_BUTTON_B3        29           // B3 / X / Y / Square / 1 / P1
#define PIN_BUTTON_B4        5            // B4 / Y / X / Triangle / 4 / P2
#define PIN_BUTTON_R1        12           // R1 / RB / R / R1 / 6 / P3
#define PIN_BUTTON_L1        17           // L1 / LB / L / L1 / 5 / P4
...
#define KEY_BUTTON_R2   HID_KEY_A             // R2 / RT / ZR / R2 / 8 / K3
#define KEY_BUTTON_L2   HID_KEY_V             // L2 / LT / ZL / L2 / 7 / K4
#define KEY_BUTTON_B3   HID_KEY_D             // B3 / X / Y / Square / 1 / P1
#define KEY_BUTTON_B4   HID_KEY_K             // B4 / Y / X / Triangle / 4 / P2
#define KEY_BUTTON_R1   HID_KEY_M             // R1 / RB / R / R1 / 6 / P3

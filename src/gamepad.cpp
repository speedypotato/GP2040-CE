...
void Gamepad::setup()
{
	...
	for (Pin_t pin = 0; pin < (Pin_t)NUM_BANK0_GPIOS; pin++)
	{
		switch (pinMappings[pin]) {
			case GpioAction::BUTTON_PRESS_UP:	mapDpadUp->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_DOWN:	mapDpadDown->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_LEFT:	mapDpadLeft->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_RIGHT:	mapDpadRight->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_B1:	mapButtonB1->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_B2:	mapButtonB2->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_B3:	mapButtonB3->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_B4:	mapButtonB4->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_L1:	mapButtonL1->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_R1:	mapButtonR1->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_L2:	mapButtonL2->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_R2:	mapButtonR2->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_S1:	mapButtonS1->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_S2:	mapButtonS2->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_L3:	mapButtonL3->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_R3:	mapButtonR3->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_A1:	mapButtonA1->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_A2:	mapButtonA2->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			case GpioAction::BUTTON_PRESS_FN:	mapButtonFn->pinMask |= (1 ^ pinActiveHigh[pin]) << pin; break;
			default:				break;
		}
	}
